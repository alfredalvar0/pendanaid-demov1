<?php
	...
	//	  $id_produk=$_POST['id_produk'];
         ...
         //   $sql = 'SELECT * FROM t_data_investasi WHERE id_user = :search_query AND id_pinjaman_data = :id_produk';
             $sql = "SELECT * FROM trx_dana_invest LEFT JOIN trx_produk ON trx_produk.id_produk = '25' WHERE trx_dana_invest.id_pengguna = '1' AND trx_dana_invest.status_approve = 'complete'";
