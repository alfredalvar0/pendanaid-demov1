...
$config['privateDir'] = array(
    'backend' => 'http://natadev.id/back_n',
    'tags'   => '.ckfinder/tags',
    // 'logs'   => '.ckfinder/logs',
    'logs' => array (
         'backend' => 'logs_backend',
         'path' => '/back_n/assets/bower_components/ckfinder/logs'
     ),
...
$config['backends'][] = array(
    'name'         => 'natadev.id/back_n',
    'adapter'      => 'sftp',
    'baseUrl'      => 'http://natadev.id/back_n/assets/bower_components/ckfinder/userfiles/',
...
$config['accessControl'][] = array(
    'role'                => '*',
    'resourceType'        => '*',
    'folder'             => '/menstruasi/assets/img/quiz',
...
$config['pluginsDirectory'] = __DIR__ . 'http://natadev.id/back_n/assets/bower_components/ckfinder/plugins';
