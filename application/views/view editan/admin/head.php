...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/bower_components/bootsrap/dist/css/bootstrap.min.css">
  <!-- Datatable -->
  ...
  <!-- Data Table -->
  <link rel="stylesheet" href="<?php echo base_url()?>assets/admin/bower_components/jquery-datatable/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="<?php echo base_url()?>assets/admin/bower_components/jquery-datatable/fixedeader/dataTables.fixedcolumns.bootstrap4.min.css">
  <link rel="stylesheet" href="<?php echo base_url()?>assets/admin/bower_components/jquery-datatable/fixedeader/dataTables.fixedheader.bootstrap4.min.css">
