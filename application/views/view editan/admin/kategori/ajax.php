  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
        <div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
	      ...
	      <div class="col-md-6">
	        <button class="form-control btn btn-primary hapus-dataKategori"> <i class="glyphicon glyphicon-ok-sign"></i> Ya</button>
	      </div>
	      <div class="col-md-6">
...
<script>
 //  	var MyTable = $('#list-data').dataTable({
	...
	function tampilKategori() {
		$.get('<?php echo base_url('Kategori/tampil'); ?>', function(data) {
