        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="col-md-2">
                <a href="<?php echo base_url() ?>Deposit/tambah">
                  <button class="form-control btn btn-primary"><i class="glyphicon glyphicon-plus-sign"></i> Deposit User</button>
                </a>
              </div>
