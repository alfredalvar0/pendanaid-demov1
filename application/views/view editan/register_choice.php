                        ...
                        <div class="col-6">
                            ...
                            <div class="form1 frm" style="padding: 25px;border: 1px solid black;">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control inp1" name="name" id="nama" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row step step1">
                                    ...
                                    <div class="col-6">
                                        <button type="button" class="btn btn-lg  btn-block" style="borderborder:2px solid #fdda0a;margin-left:5px;background-color:#fdda0a;" onclick="nextStep(2)" >Lanjut</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        setTimeout(function() { $('#nama').focus() }, 1000);
    });
