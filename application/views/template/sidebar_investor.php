...
<?php
    if(!$is_mobile){
?>
<div class="col-lg-3 d-none d-lg-block d-sm-none d-xs-none d-md-none" style="">
...
<!--
<div id="" class="shadow-lg nav-sidebar col-4" style="height: 500px; display: block; position:relative; overflow: scroll;">
