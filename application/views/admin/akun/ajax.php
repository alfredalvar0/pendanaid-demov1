  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
        <div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
	      ...
	      <div class="col-md-6">
	        <button class="form-control btn btn-primary hapus-dataAkun"> <i class="glyphicon glyphicon-ok-sign"></i> Ya</button>
	      </div>
	      <div class="col-md-6">
...
<script>
 //  	var MyTable = $('#list-data').dataTable({
	...
	// Film
	function tampilAkun() {
		$.get('<?php echo base_url('Akun/tampil'); ?>', function(data) {
	...
	var id_akun;
	$(document).on("click", ".konfirmasiHapus-akun", function() {
		id_akun = $(this).attr("data-id");
	})
	$(document).on("click", ".hapus-dataAkun", function() {
		var id = id_akun;
