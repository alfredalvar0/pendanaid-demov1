  ...
  foreach ($dataAkun->result() as $akun) {
    ...
    <tr>
      ...
      <td class="text-center" style="min-width:270px;">
        <a href="<?php echo base_url() ?>akun/detail/<?php echo $akun->id_admin ?>">
        ...
        <a href="<?php echo base_url() ?>akun/update/<?php echo $akun->id_admin ?>">
        ...
        <!--<a href="<?php echo base_url() ?>akun/update/<?php echo $akun->id_admin ?>">
          ...
          <button class="btn btn-info">
            <input type="hidden" name="id_admin" value="<?php echo $akun->id_admin ?>">
            <i class="glyphicon glyphicon-time"></i> Reset Password
          </button>
        </a>-->
