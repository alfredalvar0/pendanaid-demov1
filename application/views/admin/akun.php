        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="col-md-2">
                <a href="<?php echo base_url() ?>Akun/export_csv">
                  <button class="form-control btn btn-primary"><i class="glyphicon glyphicon-plus-sign"></i> Export</button>
                </a>
              </div>

							<!--<div class="col-md-2">
								<a href="<?php echo base_url() ?>Akun/laporanAkun">
                  <button class="form-control btn btn-success"><i class="glyphicon glyphicon-list-alt"></i> Download Data User</button>
                </a>
							</div>-->
