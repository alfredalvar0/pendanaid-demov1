<div class="content-wrapper">
  <div class=" col-md-12 well">
    ...
    <h3 style="display:block; text-align:center;">Tambah Page</h3>

    <form method="POST" enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url() ?>Meta/insert">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Page URL" name="page_uri" aria-describedby="sizing-addon2" required>
          </div>
        </div>
