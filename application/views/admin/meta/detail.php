        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="col-md-2">
                <a href="<?php echo base_url() ?>Meta/add_detail/<?= $id_header ?>">
                  <button class="form-control btn btn-primary"><i class="glyphicon glyphicon-plus-sign"></i> Tambah Data</button>
                </a>
              </div>
              <div class="col-md-2">
                <a href="<?php echo base_url() ?>Meta">
                  <button class="form-control btn btn-danger">Back to Header Table</button>
                </a>
              </div>
                ...
                <tbody>
                  <?php foreach ($data->result() as $idx => $row): ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?= base_url() ?>Meta/edit_detail/<?= $row->id_header ?>/<?= $row->id ?>" class="btn btn-sm btn-warning">Edit</a>
                        <a href="<?= base_url() ?>Meta/delete_detail/<?= $row->id_header ?>/<?= $row->id ?>" onclick="return confirm('Anda Yakin ?')" class="btn btn-sm btn-danger">Delete</a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                </tbody>
