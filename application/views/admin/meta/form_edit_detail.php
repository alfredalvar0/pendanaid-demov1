<div class="content-wrapper">
  <div class=" col-md-12 well">
    ...
    <h3 style="display:block; text-align:center;">Edit Tag</h3>

    <form method="POST" enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url() ?>Meta/update_detail/<?= $id_header ?>/<?= $data['id'] ?>">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Meta Name" name="name" aria-describedby="sizing-addon2" required value=<?= $data['name'] ?>>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Content" name="content" aria-describedby="sizing-addon2" required value="<?= $data['content'] ?>">
          </div>
        </div>
