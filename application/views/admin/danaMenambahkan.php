        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
		        ...
		        <div class="col-md-2">
		            <button type="button" class="form-control btn btn-primary" data-toggle="modal" data-target="#flipFlop"> Add Dana</button>
					</button>
		        </div>
...
<form method="POST" class="form-horizontal" action="<?php echo base_url() ?>Dana/Add">
