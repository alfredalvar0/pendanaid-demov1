<div class="content-wrapper">
  <div class=" col-md-12 well">
    ...
    <h3 style="display:block; text-align:center;">Dana Menarik <?php echo $user[0]['email']; ?> dompet</h3>

    <form method="POST" enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url() ?>DanaInvest/prosesWithdraw">
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
            <button type="submit" class="form-control btn btn-primary"> <i class="glyphicon glyphicon-ok"></i> Menarik</button>
        </div>
