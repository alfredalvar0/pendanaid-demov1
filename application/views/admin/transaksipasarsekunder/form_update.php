<div class="content-wrapper">
  <div class=" col-md-12 well">
    ...
    <form method="POST" enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url(); ?>TransaksiPasarSekunder/prosesUpdate/<?php echo $dataProduk->id_bisnis ?>">
