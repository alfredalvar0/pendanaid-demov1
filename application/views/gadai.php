...
<script>
 ...
 if($_GET['msg']=="success"){?>
 Swal.fire({
  title: "<i>Anda Telah Melakukan Gadai Saham</i>", 
  html: "Berhasil",  
  confirmButtonText: "OK", 
});
 <?php }else if($_GET['msg']=="failed"){  ?>
  Swal.fire({
  title: "<i>Gadai saham gagal</i>", 
  html: "Gagal",  
  confirmButtonText: "OK", 
});
 <?php } }?>
    ...
    <div class="container"  >
        <div class="section">
            <div class="row my-5">
				...
				<div class="col-md-6"> 
					<form method="POST" enctype="multipart/form-data" id="myForm"    class="form-horizontal"  action="<?php echo base_url() ?>invest/doGadai/<?php echo $dt->id_produk; ?>">
					  <div class="box-body">
					  ...
					  <div class="row">
						...
						<div class="col-md-6" >
							<a href="javascript:;" onclick="cekJual()" class="form-control btn btn-success" style="font-size:20px;height:40px;">
								<i class="glyphicon glyphicon-ok"></i> Gadai Saham 
							</a>
						</div>
...
function cekJual(){ 
	Swal.fire({
	  title: 'Peringatan',
	  text: "Yakin akan gadaikan saham ini?",
	  icon: 'warning',
