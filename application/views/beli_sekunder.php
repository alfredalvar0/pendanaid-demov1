					  ...
					  <div class="box-body">
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-12">
							...
							<input type="number" value="<?php echo $dt->harga_perlembar?>" min="<?= $dt->min_harga_perlembar ?>" max="<?= $dt->maks_harga_perlembar ?>" class="form-control input-price" placeholder="" name="harga_perlembar" id="harga_perlembar" aria-describedby="sizing-addon2">
						  </div>
						  <label for="inputEmail3" class="col-sm-12 control-label">
						  	<small>
<?= '* maks. Rp ' . number_format($dt->maks_harga_perlembar, 0, '', '.') . ' min. Rp ' . number_format($dt->min_harga_perlembar, 0, '', '.') ?>
							  </small>
							</label>
						</div>
						...
						<div class="form-group">
						  ...
						  <label for="inputEmail3" class="col-sm-12 control-label"><small>** sebelum dipotong biaya admin (
							<?= ($dt->jenis_biaya_admin == 'nominal') ? 'Rp ' : '' ?>
							<?= number_format($dt->nilai_biaya_admin, 0, '', '.') ?>
							<?= ($dt->jenis_biaya_admin == 'persen') ? ' %' : '' ?>)
						</div>
